...
DSD Edge Computing Chat Service
...
```json
{"name":"chat-service","status":"OK","version":"0.1.0"}
```
...
```shell
docker pull nexus.mia-platform.eu/edge-computing/chat-service:latest
set -a
source .env
docker run --name chat-service \
  ...
  -p 3000:3000 \
  --detach \
  nexus.mia-platform.eu/edge-computing/chat-service
```

[nvm]: https://github.com/creationix/nvm
[merge-request]: https://git.tools.mia-platform.eu/clients/polimi/edge-computing/services/chat-service/merge_requests
